...
if(ride.length>1){
  ...
  if(ride[0].numberOfPassengers>3){
  ...
  } else if(ride[0].numberOfPassengers<=3 && ride[0].purpleRequested==true){
    ...
    passenger1DropoffAddressLine1 = ride[0].dropoffLocation.address
    passenger1DropoffAddressLine2 = ride[0].dropoffLocation.city + [', '] + ride[0].dropoffLocation.state +[' ']+ ride[0].dropoffLocation.zip 
  } else if(ride[0].numberOfPassengers<=3 && ride[0].purpleRequested==false) {
...
//   if(ride.length==2){
//     if(ride[0].numberOfPassengers+ride[1].numberOfPassengers<=3){
//     levelOfService ='Noober Pool'
//     passenger1Name= ride[0].passengerDetails.first +[" "]+ ride[0].passengerDetails.last
//     passenger1Phone= ride[0].passengerDetails.phoneNumber
//     passenger1NumberOfPassengers=ride[0].numberOfPassengers
...
//     // passenger3DropoffAddressLine1 = ride[2].dropoffLocation.address
//     // passenger3DropoffAddressLine2 = ride[2].dropoffLocation.city + [', '] + ride[2].dropoffLocation.state +[' ']+ ride[2].dropoffLocation.zip 
//     } else if(ride[0].numberOfPassengers+ride[1].numberOfPassengers>3){
//       levelOfService ='Noober XL'
...
//   } else if(ride.length==1){
//       if(ride[0].numberOfPassengers<=3){
//         if(ride[0].purpleRequested=='FALSE'){
//       levelOfService ='Noober X'
//       passenger1Name= ride[0].passengerDetails.first +[" "]+ ride[0].passengerDetails.last
//       passenger1Phone= ride[0].passengerDetails.phoneNumber
//       passenger1NumberOfPassengers=ride[0].numberOfPassengers
...
//     if(ride[0].numberOfPassengers+ride[1].numberOfPassengers+ride[2].numberOfPassengers<=3){
//     levelOfService ='Noober Pool'
//     passenger1Name= ride[0].passengerDetails.first +[" "]+ ride[0].passengerDetails.last
//     passenger1Phone= ride[0].passengerDetails.phoneNumber
//     passenger1NumberOfPassengers=ride[0].numberOfPassengers
